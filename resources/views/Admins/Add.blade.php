                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-sm-12">
                                                <input type="text" class="form-control" name="name" placeholder="ادخل اسم الادمن">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-sm-12">
                                                <input type="text" class="form-control" name="address" placeholder="ادخل عنوان الادمن">
