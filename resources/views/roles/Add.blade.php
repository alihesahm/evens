            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="page-info shadow">
                        ...
                        <div class="content">
                            <form method="post" action="{{route('roles.create.store')}}"><!--Add Form Details Here-->
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-sm-12">
                                                <input type="text" class="form-control" name="name" placeholder="ادخل اسم الوظيفه">
                                            </div>
                                        </div>
                                        {{-- <div class="form-group row">
