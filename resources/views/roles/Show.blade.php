                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group row">
                                        <span class="col-md-3 col-sm-12 col-form-label">اسم الدور :</span>
                                        <span
                                            class="col-md-9 col-sm-12 col-form-label">{{ $role->name }}</span><!--Put Server Variable Here-->
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group row">
                                        {{-- <span class="col-md-3 col-sm-12 col-form-label">فئة المنتج :</span>
                                            <span class="col-md-9 col-sm-12 col-form-label">عطور</span><!--Put Server Variable Here--> --}}
                                    </div>
                                    <div class="form-group row">
